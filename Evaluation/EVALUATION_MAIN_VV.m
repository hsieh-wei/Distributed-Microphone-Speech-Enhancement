function title_flag=EVALUATION_MAIN_VV(indir1,indir2,indir3,outdir,outfilename,title_flag)
...
%         switch fe
%             case 8000
%                 [Return,strout]=system('/home/speechlab/Code/MATLAB/E_evaluation/PESQ +8000 cln_1.wav enh_1.wav');
%             case 16000
%                 [Return,strout]=system('/home/speechlab/Code/MATLAB/E_evaluation/PESQ +16000 cln_1.wav enh_1.wav');
%         end
